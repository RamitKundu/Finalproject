...
<div class="container">
			<div class="row main">
				...
				<center><h5>Insert Product Details</h5></center>
					...
					<form action="${req}/update"  method="post" modelAttribute="pro" enctype="multipart/form-data" >
						<input  type="hidden" name="id" value="${pro.id}"/>
						<div class="form-group">
							<label  class="cols-sm-2 control-label">Product Name</label>
							<div class="cols-sm-10">
								<div class="input-group">
									<input type="text" class="form-control" name="productName"  placeholder="Enter Product Name" value="${pro.productName}" required/>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="productPrice"   placeholder="Enter Product Price" value="${pro.productPrice}" required/>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="productDescription"   placeholder="Enter Product Description" value="${pro.productDescription}" required/>
								</div>
							</div>
						</div>
